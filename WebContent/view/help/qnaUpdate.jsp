							...
							<div class="community-post-info__header">
								<div class="answer__comment" data-id="new">
									<div class="comment__card comment__card--new">
										<form
											action="<%=request.getContextPath()%>/help/qnaUpdatePro"
											method="post" id="" class="" role="form" onsubmit="">
											<div class="comment__header flex-row">
			
												<div class="flex-column">

													<textarea name="title" class="tinymce comment-editor"
														data-id="175159" placeholder="제목을 입력해주세요.." rows="1"
														style="color: transparent; text-shadow: 0 0 0 black;">${q.title }</textarea>
												</div>
											</div>


											<textarea name="content" class="tinymce comment-editor"
												data-id="175159" placeholder="내용을 입력해주세요.." rows="10"
												style="color: transparent; text-shadow: 0 0 0 black;">${q.content }</textarea>
