							...
							<div class="community-post-info__header">
								<div class="header__title">
									<div style="display: flex; align-items: center; margin-bottom: 10px;">
										<div class="question__status-tag question__status-tag--recruited">
										<c:if test="${commentCount==0 }">미답변</c:if>
										<c:if test="${commentCount>=1 }">답변완료</c:if>
										</div>
										<h1>${q.title }</h1>
									</div>
								</div>
								<div class="header__sub-title">
									...
									<c:if test="${q.secret==2 }">&nbsp;<i class="fa fa-lock"> 비밀글</i></c:if>
										...
										<div class="comment__card">
											<div class="comment__header flex-row">
												...
												<div class="flex-column">
													<div class="flex-row">
														<a href="/users/366575" class="comment__user-name">${comment.title }</a>
													</div>
												</div>
											</div>
