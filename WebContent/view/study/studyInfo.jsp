			...
			<div id="article" class="content" role="main">
				<div class="nav" role="navigation">
					...
					<div style="margin-top: 50px">
						<span style="font-size: 24px">모델2 스터디 구합니다</span>
				...
				<div class="panel panel-default clearfix fa-">
						...
						<div class="avatar clearfix avatar-medium pull-left">
							...
							<div class="avatar-info">
								...
								<div class="date-created">
									<span class="timeago" title="2022-03-02 14:33:59">2022-03-02 14:33:59</span>
								</div>
							</div>
						</div>
					</div>
					<div class="content-container clearfix">
						<div id="content-body" class="panel-body content-body pull-left">
							...
							<h2 class="panel-title">모델2 스터디 구합니다</h2>

							<hr />
							<article class="content-text" itemprop="articleBody">
								<p>
									함께 모델2를 정복할 팀원을 찾습니다!😎👊💪<br />
								</p>
							</article>
						</div>
				...
				<div class="panel panel-default clearfix">
					...
					<ul class="list-group">
							...
							<form action="/content/update/1570494" method="post" data-id="1570494" class="note-update-form">
								...
								<div class="content-body panel-body pull-left">
									<div class="avatar clearfix avatar-medium">
										...
										<div class="avatar-info">
											<span class="nickname" title="김코딩">김코딩</span>
											<div class="date-created">
												<span class="timeago" title="2022-03-09T13:44:19">2022-03-09 13:44:19</span>
											</div>
										</div>
									</div>
									<fieldset class="form">
										<article id="note-text-1570494" class="list-group-item-text note-text">
											<p>와우~! 바로 제가 찾던 모임이네요..!😍😆</p>
										</article>
									</fieldset>
								</div>
							</form>
						...
						<li class="list-group-item note-item clearfix" id="note-1581554">
							<form action="/content/update/1581554" method="post" data-id="1581554" class="note-update-form">
								<input type="hidden" name="_method" value="PUT" id="_method" />
								<div class="content-body panel-body pull-left">
									<div class="avatar clearfix avatar-medium">
										<a href="/user/info/12306" class="avatar-photo"><img src="//www.gravatar.com/avatar/00000000000000000000000000000000?d=mm&s=40" /></a>
										<div class="avatar-info">
											<a class="nickname" href="/user/info/12306" title="코딩박사">코딩박사</a>
											<div class="date-created">
												<span class="timeago" title="2022-03-17T14:47:24">2022-03-17 14:47:24</span>
											</div>
										</div>
									</div>
									<fieldset class="form">
										<article id="note-text-1581554" class="list-group-item-text note-text">
											<p>혹시, 모집 다 다 끝난건 아니죠..?👉👈</p>
										</article>
									</fieldset>
								</div>
							</form>
							<form action="/content/delete/1581554" method="post" id="note-delete-form-1581554">
								<input type="hidden" name="_csrf" value="567dc82c-ad24-4dfc-9f4c-9b5d76a725c5" /> <input type="hidden" name="_method" value="DELETE" id="_method" />
							</form>
						</li>
							...
							<form action="/content/update/1581554" method="post" data-id="1581554" class="note-update-form">
								...
								<div class="content-body panel-body pull-left">
									<div class="avatar clearfix avatar-medium">
										<a href="/user/info/12306" class="avatar-photo"><img src="//www.gravatar.com/avatar/00000000000000000000000000000000?d=mm&s=40" /></a>
										<div class="avatar-info">
											<a class="nickname" href="/user/info/12306" title="김코딩">김코딩</a>
											<div class="date-created">
												<span class="timeago" title="2022-03-18T14:47:24">2022-03-18 14:47:24</span>
											</div>
										</div>
									</div>
									<fieldset class="form">
										<article id="note-text-1581554" class="list-group-item-text note-text">
											<p>아니에요! 지금 빨리 들어오세요~!🤩😍</p>
										</article>
									</fieldset>
								</div>
							</form>
						...
						<li class="list-group-item note-form clearfix">
							<div class="panel-body">
								<h5 class="text-center">
									<a href="/login/auth?redirectUrl=%2Farticle%2F525814" class="link">로그인</a>을 하시면 댓글을 등록할 수 있습니다.
								</h5>
							</div>
						</li>
					</ul>
