...
<c:forEach var="mt" items="${mt}">  <!-- 리스트 불러오기 --> <!-- @@css 설정으로 인해 리스트업을 위한 forEach가 적용이 안됨@@ -->
	<div class="center-col">
				...
				<div class="mtl-card">
					...
					<div class="row">
						...
						<div class="mtl-center">
							<div class="chat">
								<a
									href="<%=request.getContextPath()%>/view/mentor/mentorInfo.jsp"><button>내용보기</button></a>
							</div>
						</div>
					</div>
				</div>
	 ...
	 <div class="fnete">
		<div class="mtl-card">
			...
			<div class="row">
				<div class="mtl-col-3">
					<img src="" width="100" height="120" id="pic"><br> 멘토
					이름: 000
				</div>
				<br>
